...
**Como instalar:** ja vem embutida no repo (`.claude/skills/impeccable/`). Nao rodar `npx skills add` — instala a variante generica por cima.
**Fonte:** pbakaus/impeccable (Apache-2.0). Ver `.claude/skills/PROCEDENCIA.md`
